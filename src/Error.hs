...
data ErrorType a=UndeclaredIdentifier String|TypeMismatch (Expr a) (Expr a) (Expr a)|ExpectedPiType (Expr a)|ExpectedSigmaType (Expr a)|ExpectedSumType (Expr a)|ExpectedUniverse (Expr a) (Expr a)|DuplicateBinding String
